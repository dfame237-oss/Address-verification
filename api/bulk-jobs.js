...
            // Ready for Ship: High Quality (now includes Medium) AND NO severe critical alerts
            readyForShipRows.push(row);
        } else {
            // Manual Check: Low Quality (Bad/Very Bad) OR a severe critical alert is present
            manualCheckRows.push(row);
        }
    }
