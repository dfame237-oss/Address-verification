...
function getClientId(req) {
    ...
    try {
        // IMPORTANT: The JWT_SECRET must be available in the Vercel environment.
...
module.exports = async (req, res) => {
    ...
    try {
        // Set lastActivityAt to a historical time (e.g., 1 hour ago)
        // This instantly pushes the user below the 5-minute online threshold used by the Admin Dashboard.
        const historicalTime = new Date(Date.now() - 3600000); 
        
        // Use ObjectId constructor on the client ID string from the JWT payload
